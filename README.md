...
- Leave Tracking: Leaves taken by different job roles
- Performance Metrics: Average employee performance rating
- Salary Insights: Salary distribution across roles
- Age Analysis: Workforce distribution by age groups
- Region-wise Data: Employee count across different regions
- Employment Status: Full-time, part-time, and contract-based employees
